...
//        logResponse(response);
        ...
        try {
            transaction.setAuthNumber(resp.getField(24));
        ...
        try {
            transaction.setProdDetailCount(resp.getField(26));
        } catch (NullPointerException ex) {
        ...
        try {
            transaction.setProductCode(resp.getField(28));
        } catch (NullPointerException ex) {
            transaction.setProductCode("");
        }
        //productDetails.setMaxAmount(new BigDecimal(resp.getField(29)));
        try {
            transaction.setResponseType(resp.getField(15));
        } catch (NullPointerException ex) {
        ...
        try {
            transaction.setLocalDateTime(this.CreateDF_forTransaction(resp.getField(12)));
        } catch (NullPointerException ex) {
        ...
        try {
            transaction.setReasonCode(resp.getField(14));
        } catch (NullPointerException ex) {

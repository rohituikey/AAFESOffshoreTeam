...
//    }
//
//    public void save(List<WexSettleEntity> wexSettleMessagesList) {
//        for (WexSettleEntity wexSettleMessages : wexSettleMessagesList) {
...
//     */
//    public void update(WexSettleEntity wexSettleMessages) {
//        //Write a update query
//        // mapper.delete(settleEntity);
//        mapper.save(wexSettleMessages);
//    }
//
//    public WexSettleEntity find(String transactionfiledate, String transactionfiletime, String transactionfilesequence, 
//            String batchtid, String batchid) {
//        LOG.info("WexSettleMessageDAO.find method is started");
//
//        WexSettleEntity wexSettleMessages = null;
//        String query = "";
...
//        for (Row row : result) {
//            wexSettleMessages = new WexSettleEntity();
...
//    }
//    
//    public List<WexSettleEntity> returnTransactions() {
//        List<WexSettleEntity> result = new ArrayList<>();
//        String query = "Select * from Stargate.transactions";
//        resultSet = session.execute(query);
//
//        Result<WexSettleEntity> resultTrans = mapper.map(resultSet);
//        for(WexSettleEntity t : resultTrans){
//            result.add(t);
//        }
//        return result;
//    }
